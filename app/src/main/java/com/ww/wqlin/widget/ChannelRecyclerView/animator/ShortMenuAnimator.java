package com.ww.wqlin.widget.ChannelRecyclerView.animator;
...
/**
 * Created by wqlin on 2016/12/21.
 */

public class ShortMenuAnimator extends SimpleItemAnimator {
    ...
    public ShortMenuAnimator(RecyclerView recyclerView) {
        rv = recyclerView;
    }
