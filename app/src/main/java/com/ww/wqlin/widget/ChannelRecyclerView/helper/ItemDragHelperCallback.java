package com.ww.wqlin.widget.ChannelRecyclerView.helper;
...
public class ItemDragHelperCallback extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (manager instanceof GridLayoutManager || manager instanceof StaggeredGridLayoutManager ||manager instanceof StrongGridLayoutManager) {
