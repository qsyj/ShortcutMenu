...
/**
 * Created by wqlin on 2016/12/26.
 */

public class StrongGridLayoutManager extends LinearLayoutManager {

    private static final boolean DEBUG = false;
    private static final String TAG = "StrongGridLayoutManager";
    ...
    StrongGridLayoutManager.SpanSizeLookup mSpanSizeLookup = new StrongGridLayoutManager.DefaultSpanSizeLookup();
    // re-used variable to acquire decor insets from RecyclerView
    final Rect mDecorInsets = new Rect();
    private ICalculateItemBorders mICalculateItemBorders;
     ...
     */
    public StrongGridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                   int defStyleRes) {
    ...
    /**
     * Creates a vertical StrongGridLayoutManager
     *
     * @param context Current context, will be used to access resources.
     * @param spanCount The number of columns in the grid
     */
    public StrongGridLayoutManager(Context context, int spanCount) {
        super(context);
        setSpanCount(spanCount);
    }
    public StrongGridLayoutManager(Context context, int spanCount, ICalculateItemBorders calculateItemBorders) {
        super(context);
        mICalculateItemBorders = calculateItemBorders;
        setSpanCount(spanCount);
    }
    /**
     * @param context Current context, will be used to access resources.
     ...
     */
    public StrongGridLayoutManager(Context context, int spanCount, int orientation,
    ...
    /**
     * stackFromEnd is not supported by StrongGridLayoutManager. Consider using
    ...
    public void setStackFromEnd(boolean stackFromEnd) {
        if (stackFromEnd) {
            throw new UnsupportedOperationException(
                    "StrongGridLayoutManager does not support stack from end."
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler,
        ...
        if (!(lp instanceof StrongGridLayoutManager.LayoutParams)) {
            super.onInitializeAccessibilityNodeInfoForItem(host, info);
            return;
        }
        StrongGridLayoutManager.LayoutParams glp = (StrongGridLayoutManager.LayoutParams) lp;
    ...
    private void cachePreLayoutSpanMapping() {
        ...
        for (int i = 0; i < childCount; i++) {
            final StrongGridLayoutManager.LayoutParams lp = (StrongGridLayoutManager.LayoutParams) getChildAt(i).getLayoutParams();
    ...
    public RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == HORIZONTAL) {
            return new StrongGridLayoutManager.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                    ViewGroup.LayoutParams.FILL_PARENT);
        } else {
            return new StrongGridLayoutManager.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT,
    ...
    public RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new StrongGridLayoutManager.LayoutParams(c, attrs);
    }

    @Override
    public RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
        if (lp instanceof ViewGroup.MarginLayoutParams) {
            return new StrongGridLayoutManager.LayoutParams((ViewGroup.MarginLayoutParams) lp);
        } else {
            return new StrongGridLayoutManager.LayoutParams(lp);
        }
    }

    @Override
    public boolean checkLayoutParams(RecyclerView.LayoutParams lp) {
        return lp instanceof StrongGridLayoutManager.LayoutParams;
    }

    /**
     * Sets the source to get the number of spans occupied by each item in the adapter.
     *
     * @param spanSizeLookup {@link StrongGridLayoutManager.SpanSizeLookup} instance to be used to query number of spans
     *                       occupied by each item
     */
    public void setSpanSizeLookup(StrongGridLayoutManager.SpanSizeLookup spanSizeLookup) {
        mSpanSizeLookup = spanSizeLookup;
    }

    /**
     * Returns the current {@link StrongGridLayoutManager.SpanSizeLookup} used by the StrongGridLayoutManager.
     *
     * @return The current {@link StrongGridLayoutManager.SpanSizeLookup} used by the StrongGridLayoutManager.
     */
    public StrongGridLayoutManager.SpanSizeLookup getSpanSizeLookup() {
     ...
     * has not changed.
     */
     int[] calculateItemBorders(int[] cachedBorders, int spanCount, int totalSpace) {

        if (cachedBorders == null || cachedBorders.length != spanCount + 1
                || cachedBorders[cachedBorders.length - 1] != totalSpace) {
            cachedBorders = new int[spanCount + 1];
        }
         if (mICalculateItemBorders != null) {
             return mICalculateItemBorders.calculateItemBorders(cachedBorders, spanCount, totalSpace);
         } else {
             cachedBorders[0] = 0;
    ...
    void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        while (count < mSpanCount && layoutState.hasMore(state) && remainingSpan > 0) {
            ...
            if (spanSize > mSpanCount) {
                throw new IllegalArgumentException("Item at position " + pos + " requires " +
                        spanSize + " spans but StrongGridLayoutManager has only " + mSpanCount
                        + " spans.");
            }
        ...
        for (int i = 0; i < count; i++) {
            ...
            final StrongGridLayoutManager.LayoutParams lp = (StrongGridLayoutManager.LayoutParams) view.getLayoutParams();
        ...
        for (int i = 0; i < count; i++) {
            View view = mSet[i];
            StrongGridLayoutManager.LayoutParams params = (StrongGridLayoutManager.LayoutParams) view.getLayoutParams();
            if (mOrientation == VERTICAL) {
                if (isLayoutRTL()) {
     ...
     *
     * @see StrongGridLayoutManager#setSpanSizeLookup(StrongGridLayoutManager.SpanSizeLookup)
     */
    public static abstract class SpanSizeLookup {
        ...
        /**
         * Clears the span index cache. StrongGridLayoutManager automatically calls this method when
         ...
         * {@link #getSpanSize(int)}. StrongGridLayoutManager does not call this method for
    ...
    /**
     * Default implementation for {@link StrongGridLayoutManager.SpanSizeLookup}. Each item occupies 1 span.
     */
    public static final class DefaultSpanSizeLookup extends StrongGridLayoutManager.SpanSizeLookup {
    ...
    /**
     * LayoutParams used by StrongGridLayoutManager.
     * <p>
    ...
    public  interface ICalculateItemBorders{
        int[] calculateItemBorders(int[] cachedBorders, int spanCount, int totalSpace);
    }
}
